...
public class DrawAppearance {
    ...
    public DrawAppearance(int stroke, int fill, int strokeSize, int penType) {
    ...
    public DrawAppearance clone() {
        return new DrawAppearance(stroke, fill, strokeSize, this.penType);
    }
    ...
    public final static int PEN_TYPE_0 = 0;//default
    public final static int PEN_TYPE_1 = 1;//Fountain pen brush - Responds to stylus depth, making heavier strokes the harder the stylus presses the screen
    public final static int PEN_TYPE_2 = 2;//Stylus brush - similar to pen but with a more texturized stroke
    public final static int PEN_TYPE_3 = 3;//Highlighter brush - Thicker than other styles by default. It's semi transparent
    public final static int PEN_TYPE_4 = 4;//Pen brush - mainly to draw slim lines. Doesn't respond to stylus pressure
    public final static int PEN_TYPE_5 = 5;//Pencil brush - similar to stylus pen, but responds to stylus pressure. Has a slight granular texture
    public final static int PEN_TYPE_6 = 6;//Shapes - autocorrects input to create vector-like shapes. See Remarkable's shape tool for reference https://remarkable.com/using-remarkable/setup-and-basics/how-to-draw-shapes-on-remarkable
    public int penType = PEN_TYPE_0;
}
