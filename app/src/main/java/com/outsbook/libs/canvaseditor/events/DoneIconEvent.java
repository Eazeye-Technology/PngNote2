...
@Metadata(
        ...
        d2 = {"Lcom/outsbook/libs/canvaseditor/events/DoneIconEvent;", "Lcom/outsbook/libs/canvaseditor/listeners/StickerIconListener;", "<init>", "()V", "onActionDown", "", "stickerView", "Lcom/outsbook/libs/canvaseditor/stickers/StickerView;", "event", "Landroid/view/MotionEvent;", "onActionMove", "onActionUp", "Sources of canvaseditor.app.main"}
)
public final class DoneIconEvent implements StickerIconListener {
