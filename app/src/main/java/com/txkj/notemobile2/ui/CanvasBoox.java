package com.txkj.notemobile2.ui;
...
//        this.isPencil = true;
    ...
    public void init(Bitmap initialBmp, Bitmap background, int initialPageIdx, Activity act) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                if (this.downHandled) {
                    ...
                    if (region.width() > 0 && region.height() > 0 && region.left >= 0 && region.top >= 0) { //FIXME: stop crash
