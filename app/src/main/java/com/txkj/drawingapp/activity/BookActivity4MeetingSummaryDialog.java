...
public class BookActivity4MeetingSummaryDialog {
    ...
    public BookActivity4MeetingSummaryDialog(Activity ctx, String oldName) {
        this.mContext = ctx;
    ...
    public AlertDialog create() {
        AlertDialog dialog = new MaterialAlertDialogBuilder(this.mContext, BookActivity4Utils.getCenteredTitleThemeOverlay())
                //.setTitle(title)
                .setView(R.layout.activity_book4_meeting_summary)
                .setCancelable(true)
...
//                                tvDialogTitle.setText("Rename note");
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        //Toast.makeText(BookListActivity.this, input.getText(), Toast.LENGTH_LONG).show();
                        editMeetingSummary(dialog, input.getText().toString());
                        if (dialog != null) {
                            dialog.dismiss();
                        }
                    }
        ...
        try {
            ...
            if (window != null) {
                int WIN_WIDTH = mContext.getResources().getDimensionPixelSize(R.dimen.activity_dialog_upgrade_min_width2);
    ...
    public void editMeetingSummary(DialogInterface dialog, String newName) {
        BookActivity4Utils.editMeetingSummary(mContext, newName);
    }
}
