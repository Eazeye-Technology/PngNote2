...
public class BookActivity4DeleteMeetingDialog {
    //private final static int WIN_WIDTH = 312 + 24 * 2;//312;

    private Activity mContext;
    private Runnable mRunnable;

    public BookActivity4DeleteMeetingDialog(Activity ctx, Runnable runnable) {
        this.mContext = ctx;
    ...
    public AlertDialog create() {
        AlertDialog dialog = new MaterialAlertDialogBuilder(this.mContext, BookActivity4Utils.getCenteredTitleThemeOverlay())
                //.setTitle(title)
                .setView(R.layout.activity_book4_delete_meeting)
                .setCancelable(true)
