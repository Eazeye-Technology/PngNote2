...
public class BookActivity4EditSpeakerDialog {
    ...
    public BookActivity4EditSpeakerDialog(Activity ctx, String hintName, String oldName, Runnable runnable) {
        this.mContext = ctx;
    ...
    public AlertDialog create() {
        AlertDialog dialog = new MaterialAlertDialogBuilder(this.mContext, BookActivity4Utils.getCenteredTitleThemeOverlay())
                //.setTitle(title)
                .setView(R.layout.activity_book4_edit_speaker)
                .setCancelable(true)
...
//                        editMeetingDuration(dialog, input.getText().toString());
                        strOutput = input.getText().toString();
                        if (mRunnable != null) {
                            mRunnable.run();
                        }
                        if (dialog != null) {
