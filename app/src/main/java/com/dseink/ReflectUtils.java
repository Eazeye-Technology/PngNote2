...
public final class ReflectUtils {
    ...
    private void sortConstructors(List<Constructor<?>> list) {
        Collections.sort(list, new Comparator<Constructor<?>>() { // from class: com.geniatech.knote.notes.eink.ReflectUtils.1
    ...
    private void sortMethods(List<Method> list) {
        Collections.sort(list, new Comparator<Method>() { // from class: com.geniatech.knote.notes.eink.ReflectUtils.2
            @Override // java.util.Comparator
    ...
    public <P> P proxy(Class<P> cls) {
        ...
        return (P) Proxy.newProxyInstance(cls.getClassLoader(), new Class[]{cls}, new InvocationHandler() { // from class: com.geniatech.knote.notes.eink.ReflectUtils.3
