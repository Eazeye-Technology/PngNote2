...
public class RecordingService extends Service {
	...
	//FIXME:xunfei not support 44100
	...
	private Notification createNotification() {
        if (true) {
            ...
            Notification notification = new NotificationCompat.Builder(this, channelId)
                    ...
                    .setContentText(mDateFormat.format(mElpasedSeconds*1000))
                    .setSmallIcon(R.drawable.speech__ic_action_mic_out_light)
                    .setOngoing(true)
                    .setContentIntent(PendingIntent.getActivity(getApplicationContext(), 0,
                        new Intent(getApplicationContext(), RecordingActivity.class), PendingIntent.FLAG_IMMUTABLE))
                    .build();
            return notification;
        } else {
            NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext());
            builder.setContentTitle("Start Recording...");
            builder.setContentText(mDateFormat.format(mElpasedSeconds*1000));
            builder.setSmallIcon(R.drawable.speech__ic_action_mic_out_light);
    ...
    //https://cloud.tencent.com/developer/article/2248381
	...
	public void stopRecording() {
		...
		mDatabase.addRecording(mPrettyRecordingName,
				newFile.getAbsolutePath(), length, this.mMeetingId, this.mAgendaId, "wav", "");
	...
	public void setMeetingId(String meetingId) {
		Log.e(TAG, "=========setMeetingId " + meetingId);
