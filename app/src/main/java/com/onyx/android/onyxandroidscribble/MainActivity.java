...
//            }
//        } else if (radioButton.getId() == R.id.rb_pencil) {
//            if (checked) {
...
//            return false;
//        }
//        Canvas canvas = binding_surfaceview.getHolder().lockCanvas();
//        if (canvas == null) {
//            return false;
//        }
...
//            return;
//        }
//        Canvas lockCanvas = binding_surfaceview.getHolder().lockCanvas();
//        if (lockCanvas == null) {
//            return;
//        }
